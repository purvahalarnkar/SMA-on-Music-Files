...
[y,Fs]=audioread('ExcerptColdplay.wav');
...
subplot(4,2,5)
semilogx(af_left_o, 20*log10(abs(fft(left_o))),'b')
grid on
...
subplot(4,2,6)
semilogx(af_right_o, 20*log10(abs(fft(right_o))),'b')
grid on
axis([10e0 10e3 -100 100])
...
subplot(4,2,7)
semilogx(af_left_p, 20*log10(abs(fft(left_p))),'m')
grid on
axis([10e0 10e3 -100 100])
...
subplot(4,2,8)
semilogx(af_right_p, 20*log10(abs(fft(right_p))),'m')
grid on
axis([10e0 10e3 -100 100])
